...
These JSON stores are the sole persistence layer in Phase 1. Their responsibility boundaries match the privacy boundary described in `README.md`: only structured metadata is kept, and no raw utterances ever persist past parsing.
